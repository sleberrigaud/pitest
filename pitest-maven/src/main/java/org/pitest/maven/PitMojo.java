...
public final class PitMojo extends AbstractMojo {
  ...
  public PitMojo(RepositorySystem repositorySystem) {
    this(new RunPitStrategy(), new DependencyFilter(PluginServices.makeForLoader(
        PitMojo.class.getClassLoader())), PluginServices.makeForLoader(
        PitMojo.class.getClassLoader()), new NonEmptyProjectCheck(), repositorySystem);
  }

  public PitMojo(GoalStrategy strategy, Predicate<Artifact> filter,
